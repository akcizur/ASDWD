      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-12 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <div className="hidden md:flex items-center bg-neutral-100 dark:bg-neutral-900 p-1 rounded-xl text-xs">
            {viewModes.map((mode) => (
              <button
                ...
                className={'focus-ring px-2 py-1 rounded-lg font-medium transition-all ' + (
                  viewMode === mode.id 
          ...
          <button
            ...
            className="focus-ring w-8 h-8 rounded-full flex items-center justify-center text-neutral-800 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-all duration-200"
          >
